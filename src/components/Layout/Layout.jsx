...
import { LayoutDashboard, Building2, CheckCircle, Layers, Sparkles, Users, Bell, Settings, LogOut, Home, Menu, X } from 'lucide-react';
    ...
    <div className="admin-layout">
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          <div className="sidebar-logo"><div className="sl-icon"><Home size={18} /></div><span>Property<b>KING</b></span></div>
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            ...
            <div><p className="su-name">{user.full_name || 'Admin'}</p><p className="su-role">Administrator</p></div>
          </div>
